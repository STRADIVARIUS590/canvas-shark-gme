...
<body>
    ...
    <script>
        ...
        function run(){
            ...
            player2 = new Cuadro(getRandomInt(0, 450), getRandomInt(0, 450), 40,40, 'green')
            pared = new Cuadro(70,120,30,300, 'brown');
            pared2 = new Cuadro(400,120,30,300,'brown');
             pared3 = new Cuadro(40,0,420,30,'brown');
           pared4 = new Cuadro(40,400,410,30,'brown'); 
